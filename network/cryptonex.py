...
class Cryptonex(Bitcoin):
    ...
    name = 'cryptonex'
    symbols = ('CNX', )
    seeds = ('node-london.cryptonex.org', 'node-frankfurt.cryptonex.org', 'node-amsterdam.cryptonex.org', 'node-toronto.cryptonex.org', 'node-singapore.cryptonex.org', 'node-paris.cryptonex.org', 'node-bangalore.cryptonex.org')
    port = 20863
