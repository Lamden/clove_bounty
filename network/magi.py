...
class Magi(Bitcoin):
    ...
    name = 'magi'
    symbols = ('XMG', )
    seeds = ('seed.m-core.org', 'seed.m-chain.info', 'seed.magi.filoozom.com', 'seed.systms.org')
    port = 8233
...
class MagiTestNet(Magi):
    ...
    """
    name = 'test-magi'
    seeds = ('test-seed.m-core.org', 'test-seed.m-chain.info', 'test-seed.magi.filoozom.com', 'test-seed.systms.org')
    port = 18233
