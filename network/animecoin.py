...
class Animecoin(Bitcoin):
    ...
    name = 'animecoin'
    symbols = ('ANI', )
    seeds = ('96.43.130.251', '91.121.8.23', '62.210.151.205', '222.78.67.174', '5.9.158.79', '186.237.174.48', '82.117.232.30', '151.236.22.84', '158.255.208.40', '151.236.15.106', '91.121.8.23', '213.183.56.176', '151.236.13.37', '115.29.49.156')
    port = 1212
